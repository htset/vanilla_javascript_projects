import {slotAlreadyTaken, updateAppointment, deleteAppointment,
  selectSlot, updateDisplayedDate, addDaysToDate } from './logic.js';
...
export const createAppointmentList = function () {
  for (let i = 0; i < 24; i++) {
    //create <li> element
...
export const clearAppointmentsList = function () {
  for (let i = 0; i < 24; i++) {
...
export const updateUI = function (state) {
